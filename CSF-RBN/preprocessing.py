...
#====================== CTX =================================
def rename_rbn_columns(df, mouse_map):
...
dss = pd.read_csv("RBN_data/DSS.csv")
vecpac = pd.read_csv("RBN_data/VECPAC.csv")
lps = pd.read_csv("RBN_data/LPS.csv")

dss_map = pd.read_csv("RBN_data/DSS_group_map.csv", header=None)
vecpac_map = pd.read_csv("RBN_data/VECPAC_group_map.csv", header=None)
lps_map = pd.read_csv("RBN_data/LPS_group_map.csv", header=None)
...
mouse_map = pd.read_csv("RBN_data/mouse_map.csv")
...
str_dss = rename_rbn_columns(str_dss, mouse_map)
str_vecpac = rename_rbn_columns(str_vecpac, mouse_map)
str_lps = rename_rbn_columns(str_lps, mouse_map)
