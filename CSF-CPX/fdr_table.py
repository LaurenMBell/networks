...
vecpac = rename_correlation_columns(pd.read_csv("VECPAC_correlations.csv"), "VECPAC")
lps = rename_correlation_columns(pd.read_csv("LPS_correlations.csv"), "LPS")
dss = rename_correlation_columns(pd.read_csv("DSS_correlations.csv"), "DSS")
pooled = rename_correlation_columns(pd.read_csv("pooled_correlations.csv"), "Pooled")
